...
<?php
    $section_sql = "select c.description from take t join student s on s.student_id = t.student_id join course c on c.course_id = s.course_id where i.student_id=" . $row["student_id"];
