...
<?php      
    $section_sql = "select c.description from take t join student s on s.register_id = t.register_id join course c on c.course_id = t.course_id where s.student_id=" . $row["student_id"];
