...
<?php
    $section_sql = "select c.description from student s join take t on s.student_id = t.student_id join course c on c.course_id = s.course_id where s.student_id=" . $row["student_id"];
