...
<?php
    $section_sql = "select c.description from student s join take t on s.register_id = t.register_id join course c on c.course_id = t.course_id where c.student_id=" . $row["student_id"];
