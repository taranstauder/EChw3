...
$sql = "select course_id, description, i.instructor_name, instructor_id, c.prefix, c.number, instructor_office from course c join instructor i on i.instructor_id = c.instructor_id";
